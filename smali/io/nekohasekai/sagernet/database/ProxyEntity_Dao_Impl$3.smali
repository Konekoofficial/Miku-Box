.class Lio/nekohasekai/sagernet/database/ProxyEntity_Dao_Impl$3;
...
.method public constructor <init>(Lio/nekohasekai/sagernet/database/ProxyEntity_Dao_Impl;Landroidx/room/RoomDatabase;)V
    ...
    iput-object p1, p0, Lio/nekohasekai/sagernet/database/ProxyEntity_Dao_Impl$3;->this$0:Lio/nekohasekai/sagernet/database/ProxyEntity_Dao_Impl;
...
.method public bridge synthetic bind(Landroidx/sqlite/db/SupportSQLiteStatement;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lio/nekohasekai/sagernet/database/ProxyEntity_Dao_Impl$3;->bind(Landroidx/sqlite/db/SupportSQLiteStatement;Lio/nekohasekai/sagernet/database/ProxyEntity;)V
...
.method public createQuery()Ljava/lang/String;
    ...
    const-string v0, "UPDATE OR ABORT `proxy_entities` SET `id` = ?,`groupId` = ?,`type` = ?,`userOrder` = ?,`tx` = ?,`rx` = ?,`status` = ?,`ping` = ?,`uuid` = ?,`error` = ?,`socksBean` = ?,`httpBean` = ?,`ssBean` = ?,`vmessBean` = ?,`trojanBean` = ?,`trojanGoBean` = ?,`mieruBean` = ?,`naiveBean` = ?,`hysteriaBean` = ?,`tuicBean` = ?,`sshBean` = ?,`wgBean` = ?,`shadowTLSBean` = ?,`anyTLSBean` = ?,`chainBean` = ?,`nekoBean` = ?,`configBean` = ? WHERE `id` = ?"

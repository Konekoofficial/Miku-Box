...
.method public static final asExecutor(Lkotlinx/coroutines/scheduling/DefaultIoScheduler;)Ljava/util/concurrent/Executor;
    .locals 1
...
.method public static final handleCoroutineException(Lkotlin/coroutines/CoroutineContext;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v0, p1}, Lkotlinx/coroutines/android/AndroidExceptionPreHandler;->handleException(Ljava/lang/Throwable;)V
    :try_end_0
...
.method public static launch$default(Lkotlinx/coroutines/CoroutineScope;Lkotlinx/coroutines/CoroutineDispatcher;Lkotlin/jvm/functions/Function2;I)Lkotlinx/coroutines/StandaloneCoroutine;
    .locals 1
...
.method public static final newFixedThreadPoolContext(ILjava/lang/String;)Lkotlinx/coroutines/ExecutorCoroutineDispatcherImpl;
    .locals 2
    ...
    new-instance p1, Lkotlinx/coroutines/ExecutorCoroutineDispatcherImpl;

    invoke-direct {p1, p0}, Lkotlinx/coroutines/ExecutorCoroutineDispatcherImpl;-><init>(Ljava/util/concurrent/Executor;)V
...
.method public static runBlocking$default(Lkotlin/jvm/functions/Function2;)V
    ...
    invoke-static {v0, v3, v4}, Lkotlinx/coroutines/JobKt;->foldCopies(Lkotlin/coroutines/CoroutineContext;Lkotlin/coroutines/CoroutineContext;Z)Lkotlin/coroutines/CoroutineContext;
    ...
    invoke-direct {v2, v0, v1, v3}, Lkotlinx/coroutines/BlockingCoroutine;-><init>(Lkotlin/coroutines/CoroutineContext;Ljava/lang/Thread;Lkotlinx/coroutines/EventLoopImplPlatform;)V

    invoke-virtual {v2, v4, v2, p0}, Lkotlinx/coroutines/AbstractCoroutine;->start(ILkotlinx/coroutines/AbstractCoroutine;Lkotlin/jvm/functions/Function2;)V

    const/4 p0, 0x0

    iget-object v0, v2, Lkotlinx/coroutines/BlockingCoroutine;->eventLoop:Lkotlinx/coroutines/EventLoopImplPlatform;

    if-eqz v0, :cond_1

    sget v1, Lkotlinx/coroutines/EventLoopImplPlatform;->$r8$clinit:I

    invoke-virtual {v0, p0}, Lkotlinx/coroutines/EventLoopImplPlatform;->incrementUseCount(Z)V
    ...
    invoke-virtual {v0}, Lkotlinx/coroutines/EventLoopImplPlatform;->processNextEvent()J
    ...
    invoke-virtual {v0, p0}, Lkotlinx/coroutines/EventLoopImplPlatform;->decrementUseCount(Z)V
    ...
    invoke-virtual {v2, v1}, Lkotlinx/coroutines/JobSupport;->cancelImpl$kotlinx_coroutines_core(Ljava/lang/Object;)Z
...
.method public static final withContext(Lkotlin/coroutines/AbstractCoroutineContextElement;Lkotlin/jvm/functions/Function2;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    .locals 4
    ...
    invoke-static {v0, v0, p1}, Lkotlin/ExceptionsKt;->startUndispatchedOrReturn(Lkotlinx/coroutines/internal/ScopeCoroutine;Lkotlinx/coroutines/internal/ScopeCoroutine;Lkotlin/jvm/functions/Function2;)Ljava/lang/Object;
    ...
    invoke-static {p1, v0, v0}, Landroidx/room/util/DBUtil;->startCoroutineCancellable$default(Lkotlin/jvm/functions/Function2;Lkotlinx/coroutines/AbstractCoroutine;Lkotlinx/coroutines/AbstractCoroutine;)V

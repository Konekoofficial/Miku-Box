...
# direct methods
.method constructor <init>(Lj$/util/stream/b;Lj$/util/U;Z)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lj$/util/stream/j3;->b:Lj$/util/stream/b;

    const/4 p1, 0x0

    iput-object p1, p0, Lj$/util/stream/j3;->c:Ljava/util/function/Supplier;

    iput-object p2, p0, Lj$/util/stream/j3;->d:Lj$/util/U;

    iput-boolean p3, p0, Lj$/util/stream/j3;->a:Z
...
.method constructor <init>(Lj$/util/stream/b;Ljava/util/function/Supplier;Z)V
    ...
    iput-object p2, p0, Lj$/util/stream/j3;->c:Ljava/util/function/Supplier;

    const/4 p1, 0x0

    iput-object p1, p0, Lj$/util/stream/j3;->d:Lj$/util/U;
...
.method private b()Z
    ...
    iget-object v0, p0, Lj$/util/stream/j3;->e:Lj$/util/stream/r2;
    ...
    iget-object v0, p0, Lj$/util/stream/j3;->f:Ljava/util/function/BooleanSupplier;
    ...
    iput-boolean v4, p0, Lj$/util/stream/j3;->i:Z
...
.method final a()Z
    ...
    invoke-virtual {p0}, Lj$/util/stream/j3;->d()V

    iput-wide v1, p0, Lj$/util/stream/j3;->g:J

    iget-object v0, p0, Lj$/util/stream/j3;->e:Lj$/util/stream/r2;

    iget-object v1, p0, Lj$/util/stream/j3;->d:Lj$/util/U;
    ...
    invoke-direct {p0}, Lj$/util/stream/j3;->b()Z
    ...
    :cond_1
    iget-wide v4, p0, Lj$/util/stream/j3;->g:J

    const-wide/16 v6, 0x1

    add-long/2addr v4, v6

    iput-wide v4, p0, Lj$/util/stream/j3;->g:J
...
.method final c()V
    ...
    iget-object v0, p0, Lj$/util/stream/j3;->d:Lj$/util/U;

    if-nez v0, :cond_0

    iget-object v0, p0, Lj$/util/stream/j3;->c:Ljava/util/function/Supplier;
    ...
    iput-object v0, p0, Lj$/util/stream/j3;->d:Lj$/util/U;

    const/4 v0, 0x0

    iput-object v0, p0, Lj$/util/stream/j3;->c:Ljava/util/function/Supplier;
...
.method abstract e(Lj$/util/U;)Lj$/util/stream/j3;
.end method
...
.method public final getComparator()Ljava/util/Comparator;
    ...
    invoke-static {p0, v0}, Lj$/util/b;->e(Lj$/util/U;I)Z
...
.method public trySplit()Lj$/util/U;
    ...
    iget-boolean v0, p0, Lj$/util/stream/j3;->a:Z
    ...
    :cond_0
    invoke-virtual {p0, v0}, Lj$/util/stream/j3;->e(Lj$/util/U;)Lj$/util/stream/j3;

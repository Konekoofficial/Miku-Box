...
.method constructor <init>(Lj$/util/U;JJ)V
    ...
    iput-object p1, p0, Lj$/util/stream/J3;->a:Lj$/util/U;
    ...
    :cond_1
    iput-wide v0, p0, Lj$/util/stream/J3;->d:J

    const/16 v0, 0x80

    iput v0, p0, Lj$/util/stream/J3;->c:I
    ...
    iput-object v0, p0, Lj$/util/stream/J3;->e:Ljava/util/concurrent/atomic/AtomicLong;

    return-void
.end method

.method constructor <init>(Lj$/util/U;Lj$/util/stream/J3;)V
    .locals 2
    ...
    iget-object p1, p2, Lj$/util/stream/J3;->e:Ljava/util/concurrent/atomic/AtomicLong;

    iput-object p1, p0, Lj$/util/stream/J3;->e:Ljava/util/concurrent/atomic/AtomicLong;

    iget-wide v0, p2, Lj$/util/stream/J3;->d:J

    iput-wide v0, p0, Lj$/util/stream/J3;->d:J

    iget p1, p2, Lj$/util/stream/J3;->c:I

    iput p1, p0, Lj$/util/stream/J3;->c:I
...
.method protected final b(J)J
    ...
    :cond_0
    iget-object v0, p0, Lj$/util/stream/J3;->e:Ljava/util/concurrent/atomic/AtomicLong;

    invoke-virtual {v0}, Ljava/util/concurrent/atomic/AtomicLong;->get()J

    move-result-wide v1

    iget-boolean v3, p0, Lj$/util/stream/J3;->b:Z
...
.method protected abstract c(Lj$/util/U;)Lj$/util/U;
.end method
...
.method protected final d()Lj$/util/stream/I3;
    .locals 5
    ...
    sget-object v0, Lj$/util/stream/I3;->MAYBE_MORE:Lj$/util/stream/I3;
    ...
    sget-object v0, Lj$/util/stream/I3;->UNLIMITED:Lj$/util/stream/I3;

    goto :goto_0

    :cond_1
    sget-object v0, Lj$/util/stream/I3;->NO_MORE:Lj$/util/stream/I3;
...
.method public bridge synthetic trySplit()Lj$/util/H;
    ...
    invoke-virtual {p0}, Lj$/util/stream/J3;->trySplit()Lj$/util/U;
...
.method public final trySplit()Lj$/util/U;
    ...
    :cond_1
    invoke-virtual {p0, v0}, Lj$/util/stream/J3;->c(Lj$/util/U;)Lj$/util/U;

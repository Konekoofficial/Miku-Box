...
.method public constructor <init>()V
    ...
    iput-wide v0, p0, Lj$/util/m;->min:J

    const-wide/high16 v0, -0x8000000000000000L

    iput-wide v0, p0, Lj$/util/m;->max:J
...
.method public final accept(I)V
    ...
    invoke-virtual {p0, v0, v1}, Lj$/util/m;->accept(J)V
...
.method public final accept(J)V
    ...
    iget-wide v0, p0, Lj$/util/m;->min:J
    ...
    iget-wide v0, p0, Lj$/util/m;->max:J

    invoke-static {v0, v1, p1, p2}, Ljava/lang/Math;->max(JJ)J

    move-result-wide p1

    iput-wide p1, p0, Lj$/util/m;->max:J
...
.method public final b(Lj$/util/m;)V
    .locals 4
    ...
    iget-wide v2, p1, Lj$/util/m;->min:J
    ...
    iget-wide v2, p1, Lj$/util/m;->max:J
...
.method public final toString()Ljava/lang/String;
    ...
    iget-wide v2, p0, Lj$/util/m;->sum:J

    invoke-static {v2, v3}, Ljava/lang/Long;->valueOf(J)Ljava/lang/Long;

    move-result-object v2

    iget-wide v3, p0, Lj$/util/m;->min:J

    invoke-static {v3, v4}, Ljava/lang/Long;->valueOf(J)Ljava/lang/Long;

    move-result-object v3

    iget-wide v4, p0, Lj$/util/m;->count:J
    ...
    iget-wide v6, p0, Lj$/util/m;->sum:J
    ...
    iget-wide v5, p0, Lj$/util/m;->max:J
